...
def run_QFF_SMV_qEI_normal():
    ...
    main(
        ...
        ref_optf="forrester_MV_Normal_0.005_alpha_5_Opt_F.txt",
...
def run_MT_MVA_BO_normal():
    ...
    main(
        ...
        q=1,
        fp=os.path.join("normal", "q1"),
        kw_acq={"noise_type": "normal", "noise_param": [[0.005]], "approx_mc_num": 100, "alpha": 5.0},
        kw_bench={"doe_num": 5, "initial_x": "Stored"},
        kw_optimize={"acquire_return_builder": True},
        kw_optimizer={
            "x_delta": 1.96 * tf.sqrt(tf.constant([0.005], tf.float64)),
...
def run_MT_MVA_BO_uniform():
    ...
    main(
        ...
        q=1,
        fp=os.path.join("uniform", "q1"),
        kw_acq={"noise_type": "uniform", "noise_param": [0.1], "approx_mc_num": 100, "alpha": 5},
        kw_bench={"doe_num": 5, "initial_x": "Stored"},
        kw_optimize={"acquire_return_builder": True},
        kw_optimizer={
