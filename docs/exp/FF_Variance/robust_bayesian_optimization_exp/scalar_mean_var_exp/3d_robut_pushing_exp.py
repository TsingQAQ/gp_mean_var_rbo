...
def run_QFF_SMV_qEI_normal():
    ...
    main(
        ...
        ref_optf="Robot_Pushing_3D_SMV_Normal_S_4_Opt_F.txt",
...
def run_QFF_SMV_qEI_uniform():
    ...
    main(
        ...
        n=100,
        n_tp="uniform",
        n_p=tf.constant([0.02, 0.02, 0.02], dtype=tf.float64),
        q=1,
        fp=os.path.join("uniform", "q1_qff"),
        kw_acq={
            "noise_type": "uniform",
            "noise_param": tf.constant([0.02, 0.02, 0.02], dtype=tf.float64),
            "ff_method": "QFF",
            "opt_ff_num": 10,
            "infer_mc_num": 10000,
            "alpha_var": 2.0,
        ...
        ref_optf="Robot_Pushing_3D_SMV_Uniform_S_4_Opt_F.txt",
        kw_bench={"doe_num": 15, "initial_x": "Stored"},
        kw_rule={"num_initial_samples": 20, "num_optimization_runs": 1},
        kw_optimize={"acquire_return_builder": True},
        sc_alpha=2.0,
...
def run_US_uniform():
    ...
    main(
        ...
        kw_rule={"num_initial_samples": 20, "num_optimization_runs": 1},
        kw_optimizer={
            "x_delta": tf.constant([0.02, 0.02, 0.02], dtype=tf.float64),
            "kw_al": {"which_al_obj": "std"},
        },
        kw_optimize={"acquire_return_builder": True},
        ref_optf="Robot_Pushing_3D_SMV_Uniform_S_4_Opt_F.txt",
