...
def run_QFF_MV_qECI_uniform():
    ...
    main(
        ...
        n=50,
        n_tp="uniform",
        n_p=tf.constant([0.05, 0.05], dtype=tf.float64),
        q=1,
        fp=os.path.join("uniform", "q1_qff"),
        kw_acq={
            "noise_type": "uniform",
            "noise_param": tf.constant([0.05, 0.05], dtype=tf.float64),
            "ff_method": "QFF",
            "opt_ff_num": 30,
            "infer_mc_num": 10000,
            "variance_threshold": 160.0,
            ...
            "rec_var_prob_threshold": 0.8,
            "implicit_sample": True,
            "pseudo_min": 310.5339317658256,
        },
        kw_bench={"doe_num": 10, "initial_x": "Stored"},
        kw_rule={"num_initial_samples": 20, "num_optimization_runs": 1},
        kw_optimize={"acquire_return_builder": True},
        ref_optf="Branin_MV_Uniform_0.05_Opt_F.txt",
        kw_metrics={"worst_obj_val": 310.5339317658256},
        vc=160.0,
        which_rec="acquisition.recommend",
    )
...
def run_US_uniform():
    ...
    main(
        ...
        kw_optimize={"acquire_return_builder": True},
        kw_optimizer={
            "x_delta": tf.constant([0.05, 0.05], dtype=tf.float64),
            "kw_al": {"which_al_obj": "std"},
        },
        ref_optf="Branin_MV_Uniform_0.05_Opt_F.txt",
        kw_metrics={"worst_obj_val": 310.5339317658256},
