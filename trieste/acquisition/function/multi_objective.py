...
class ExpectedHypervolumeImprovement(SingleModelAcquisitionBuilder[ProbabilisticModel]):
    ...
    def __init__(self, reference_point_setting: [dir, TensorType] = "default"):
        super().__init__()
        self._ref_pt_setting = reference_point_setting
    ...
    def prepare_acquisition_function(
        ...
        _pf = Pareto(mean)
        if not isinstance(self._ref_pt_setting, str):
            _reference_pt = tf.cast(self._ref_pt_setting, dtype=dataset.observations.dtype)
        elif self._ref_pt_setting == "default":
            _reference_pt = get_reference_point(_pf.front)
        else:
            raise ValueError("Reference type not understood")
...
class BatchMonteCarloExpectedHypervolumeImprovement(
    ...
    def __init__(
        ...
        *,
        ...
        reference_point_setting: [dir, TensorType] = "default",
    ):
        """
